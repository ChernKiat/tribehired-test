...
class Multiverse extends Model
{
    ...
    {
        // foreach ($this->assets as $asset) {
            $this->asset->generateBlackImages('0_black.png', public_path(self::PATH_INPUT_FOLDER), public_path(self::PATH_IMAGE_FOLDER . "{$this->id}/"), 4, 4);
            // $asset->generateBlackImages($this->asset->original_image "{$this->id}/{$this->index}_black", public_path(self::PATH_INPUT_FOLDER), public_path(self::PATH_IMAGE_FOLDER . "{$this->id}/"), 4, 4);...........
        // }
    }
    ...
    public function generateCustomImages()
    {
        foreach ($this->assets as $asset) {
            switch ($asset->index) {
                case 0:
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_black.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_0.png");
                    break;
                case 1:
                    for ($i = 0; $i < 12; $i++) {
                        copy(public_path(self::PATH_INPUT_FOLDER . dechex($i) . '.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_{$i}.png");
                    }
                    break;
                case 2:
                    copy(public_path(self::PATH_INPUT_FOLDER . '1_2_3_4_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_0.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_2_3_4_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_1.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_3_4_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_0.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_4_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_3.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_5_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_4.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_6_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_5.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_7_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_6.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_6_8_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_7.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_6_7_9_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_8.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_6_7_8_a_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_9.png");
                    copy(public_path(self::PATH_INPUT_FOLDER . '0_1_2_3_4_5_6_7_8_9_b.png'), public_path(self::PATH_IMAGE_FOLDER) . Multiverse::PROJECT_MULTIVERSE . "/{$asset->index}_custom_10.png");
