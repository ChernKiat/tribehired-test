    ...
    var _Html = function()
    {
        ...
        function UpdateHtmlTableCell_Board(html, board, square)
        {
            ...
            if (square.Tile != 0)
            {
                ...
                var txt1 = document.createTextNode(square.Tile.Top);
                var span1 = document.createElement('span');
                span1.setAttribute('class', 'Top');
                span1.appendChild(txt1);
                a.appendChild(span1);

                var txt2 = document.createTextNode(square.Tile.Right);
                var span2 = document.createElement('span');
                span2.setAttribute('class', 'Right');
                span2.appendChild(txt2);
                a.appendChild(span2);

                var txt3 = document.createTextNode(square.Tile.Bottom);
                var span3 = document.createElement('span');
                span3.setAttribute('class', 'Bottom');
                span3.appendChild(txt3);
                a.appendChild(span3);

                var txt4 = document.createTextNode(square.Tile.Left);
                var span4 = document.createElement('span');
                span4.setAttribute('class', 'Left');
            ...
            else
            {
                ...
                switch (square.Type)
                {
                    case SquareType.Normal:
                        ...
                        a.appendChild(span1);
                        break;
                    case SquareType.AddFive:
                        var span = document.createElement('span');
                        var txt1 = document.createTextNode("+5");
                        span.appendChild(txt1);
                        a.appendChild(span);
                        break;
                    case SquareType.SubtractFive:
                        var span = document.createElement('span');
                        var txt1 = document.createTextNode("-5");
                        span.appendChild(txt1);
                        a.appendChild(span);
                        break;
                    case SquareType.MultiplyTwo:
                        var span = document.createElement('span');
                        var txt1 = document.createTextNode("x2");
                        span.appendChild(txt1);
                        a.appendChild(span);
                        break;
                    case SquareType.DivideTwo:
                        var span = document.createElement('span');
                        var txt1 = document.createTextNode("%2");
                        span.appendChild(txt1);
                        a.appendChild(span);
                        break;
                    default:
        ...
        function DrawHtmlTable_Board(html, board)
        {
            ...
            for (var y = 0; y < board.Dimension; y++)
            {
                ...
                for (var x = 0; x < board.Dimension; x++)
                {
                    ...
                    if (square.Type == SquareType.AddFive) {
                        td.setAttribute('class', 'AddFive');
                    } else if (square.Type == SquareType.SubtractFive) {
                        td.setAttribute('class', 'SubtractFive');
                    } else if (square.Type == SquareType.MultiplyTwo) {
                        td.setAttribute('class', 'MultiplyTwo');
                    } else if (square.Type == SquareType.DivideTwo) {
                        td.setAttribute('class', 'DivideTwo');
                    } else {
        ...
        function DrawHtmlTable_LetterTiles(html, game)
        {
            ...
            for (var i = 0; i < letterDistribution.Letters.length; i++)
            {
                ...
                var txt1 = document.createTextNode(tile.Top);
                var span1 = document.createElement('span');
                span1.setAttribute('class', 'Top');
                span1.appendChild(txt1);
                a.appendChild(span1);

                var txt2 = document.createTextNode(tile.Right);
                var span2 = document.createElement('span');
                span2.setAttribute('class', 'Right');
                span2.appendChild(txt2);
                a.appendChild(span2);

                var txt3 = document.createTextNode(tile.Bottom);
                var span3 = document.createElement('span');
                span3.setAttribute('class', 'Bottom');
                span3.appendChild(txt3);
                a.appendChild(span3);

                var txt4 = document.createTextNode(tile.Left);
                var span4 = document.createElement('span');
                span4.setAttribute('class', 'Left');
                span4.appendChild(txt4);
                a.appendChild(span4);
